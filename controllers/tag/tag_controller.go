...
// +kubebuilder:rbac:groups=tag.vsphere.kubeform.com,resources=tags,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=tag.vsphere.kubeform.com,resources=tags/status,verbs=get;update;patch
...
func (r *TagReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
