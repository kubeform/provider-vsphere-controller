...
// +kubebuilder:rbac:groups=compute.vsphere.kubeform.com,resources=clusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=compute.vsphere.kubeform.com,resources=clusters/status,verbs=get;update;patch
...
func (r *ClusterReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &computev1alpha1.Cluster{}); err != nil {
			klog.Error(err, "unable to set up auditor", computev1alpha1.Cluster{}.APIVersion, computev1alpha1.Cluster{}.Kind)
			return err
		}
	}
