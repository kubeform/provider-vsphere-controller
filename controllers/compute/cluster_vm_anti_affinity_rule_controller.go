...
// +kubebuilder:rbac:groups=compute.vsphere.kubeform.com,resources=clustervmantiaffinityrules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=compute.vsphere.kubeform.com,resources=clustervmantiaffinityrules/status,verbs=get;update;patch
...
func (r *ClusterVmAntiAffinityRuleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &computev1alpha1.ClusterVmAntiAffinityRule{}); err != nil {
			klog.Error(err, "unable to set up auditor", computev1alpha1.ClusterVmAntiAffinityRule{}.APIVersion, computev1alpha1.ClusterVmAntiAffinityRule{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&computev1alpha1.ClusterVmAntiAffinityRule{}).
