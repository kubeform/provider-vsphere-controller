...
// +kubebuilder:rbac:groups=ha.vsphere.kubeform.com,resources=vmoverrides,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ha.vsphere.kubeform.com,resources=vmoverrides/status,verbs=get;update;patch
...
func (r *VmOverrideReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &hav1alpha1.VmOverride{}); err != nil {
			klog.Error(err, "unable to set up auditor", hav1alpha1.VmOverride{}.APIVersion, hav1alpha1.VmOverride{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&hav1alpha1.VmOverride{}).
