...
// +kubebuilder:rbac:groups=host.vsphere.kubeform.com,resources=hosts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=host.vsphere.kubeform.com,resources=hosts/status,verbs=get;update;patch
...
func (r *HostReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Host")
...
func (r *HostReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &hostv1alpha1.Host{}); err != nil {
			klog.Error(err, "unable to set up auditor", hostv1alpha1.Host{}.APIVersion, hostv1alpha1.Host{}.Kind)
			return err
		}
	}
...
func (r *HostReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Host")
			return nil
		}
		...
		resourceList := &hostv1alpha1.HostList{}
