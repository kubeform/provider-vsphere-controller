...
// +kubebuilder:rbac:groups=host.vsphere.kubeform.com,resources=portgroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=host.vsphere.kubeform.com,resources=portgroups/status,verbs=get;update;patch
...
func (r *PortGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &hostv1alpha1.PortGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", hostv1alpha1.PortGroup{}.APIVersion, hostv1alpha1.PortGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&hostv1alpha1.PortGroup{}).
