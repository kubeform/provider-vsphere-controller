...
// +kubebuilder:rbac:groups=host.vsphere.kubeform.com,resources=virtualswitches,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=host.vsphere.kubeform.com,resources=virtualswitches/status,verbs=get;update;patch
...
func (r *VirtualSwitchReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &hostv1alpha1.VirtualSwitch{}); err != nil {
			klog.Error(err, "unable to set up auditor", hostv1alpha1.VirtualSwitch{}.APIVersion, hostv1alpha1.VirtualSwitch{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&hostv1alpha1.VirtualSwitch{}).
