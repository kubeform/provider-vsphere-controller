...
// +kubebuilder:rbac:groups=role.vsphere.kubeform.com,resources=roles,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=role.vsphere.kubeform.com,resources=roles/status,verbs=get;update;patch
...
func (r *RoleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &rolev1alpha1.Role{}); err != nil {
			klog.Error(err, "unable to set up auditor", rolev1alpha1.Role{}.APIVersion, rolev1alpha1.Role{}.Kind)
			return err
		}
	}
