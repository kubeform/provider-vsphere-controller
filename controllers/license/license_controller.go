...
// +kubebuilder:rbac:groups=license.vsphere.kubeform.com,resources=licenses,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=license.vsphere.kubeform.com,resources=licenses/status,verbs=get;update;patch
...
func (r *LicenseReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &licensev1alpha1.License{}); err != nil {
			klog.Error(err, "unable to set up auditor", licensev1alpha1.License{}.APIVersion, licensev1alpha1.License{}.Kind)
			return err
		}
	}
