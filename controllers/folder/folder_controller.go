...
// +kubebuilder:rbac:groups=folder.vsphere.kubeform.com,resources=folders,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=folder.vsphere.kubeform.com,resources=folders/status,verbs=get;update;patch
...
func (r *FolderReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &folderv1alpha1.Folder{}); err != nil {
			klog.Error(err, "unable to set up auditor", folderv1alpha1.Folder{}.APIVersion, folderv1alpha1.Folder{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&folderv1alpha1.Folder{}).
