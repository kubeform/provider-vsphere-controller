...
// +kubebuilder:rbac:groups=resource.vsphere.kubeform.com,resources=pools,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=resource.vsphere.kubeform.com,resources=pools/status,verbs=get;update;patch
...
func (r *PoolReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Pool")
...
func (r *PoolReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &resourcev1alpha1.Pool{}); err != nil {
			klog.Error(err, "unable to set up auditor", resourcev1alpha1.Pool{}.APIVersion, resourcev1alpha1.Pool{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&resourcev1alpha1.Pool{}).
