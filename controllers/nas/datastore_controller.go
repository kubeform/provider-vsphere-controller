...
// +kubebuilder:rbac:groups=nas.vsphere.kubeform.com,resources=datastores,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=nas.vsphere.kubeform.com,resources=datastores/status,verbs=get;update;patch
...
func (r *DatastoreReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &nasv1alpha1.Datastore{}); err != nil {
			klog.Error(err, "unable to set up auditor", nasv1alpha1.Datastore{}.APIVersion, nasv1alpha1.Datastore{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&nasv1alpha1.Datastore{}).
