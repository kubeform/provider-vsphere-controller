...
// +kubebuilder:rbac:groups=file.vsphere.kubeform.com,resources=files,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=file.vsphere.kubeform.com,resources=files/status,verbs=get;update;patch
...
func (r *FileReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &filev1alpha1.File{}); err != nil {
			klog.Error(err, "unable to set up auditor", filev1alpha1.File{}.APIVersion, filev1alpha1.File{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&filev1alpha1.File{}).
