...
// +kubebuilder:rbac:groups=virtual.vsphere.kubeform.com,resources=machines,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=virtual.vsphere.kubeform.com,resources=machines/status,verbs=get;update;patch
...
func (r *MachineReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &virtualv1alpha1.Machine{}); err != nil {
			klog.Error(err, "unable to set up auditor", virtualv1alpha1.Machine{}.APIVersion, virtualv1alpha1.Machine{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&virtualv1alpha1.Machine{}).
...
func (r *MachineReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Machine")
			return nil
		}
		...
		resourceList := &virtualv1alpha1.MachineList{}
