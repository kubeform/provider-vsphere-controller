...
// +kubebuilder:rbac:groups=virtual.vsphere.kubeform.com,resources=disks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=virtual.vsphere.kubeform.com,resources=disks/status,verbs=get;update;patch
...
func (r *DiskReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Disk")
...
func (r *DiskReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &virtualv1alpha1.Disk{}); err != nil {
			klog.Error(err, "unable to set up auditor", virtualv1alpha1.Disk{}.APIVersion, virtualv1alpha1.Disk{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&virtualv1alpha1.Disk{}).
