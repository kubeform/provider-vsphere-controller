...
// +kubebuilder:rbac:groups=content.vsphere.kubeform.com,resources=libraries,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=content.vsphere.kubeform.com,resources=libraries/status,verbs=get;update;patch
...
func (r *LibraryReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &contentv1alpha1.Library{}); err != nil {
			klog.Error(err, "unable to set up auditor", contentv1alpha1.Library{}.APIVersion, contentv1alpha1.Library{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&contentv1alpha1.Library{}).
