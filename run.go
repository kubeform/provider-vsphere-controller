...
import (
	...
	vspherescheme "kubeform.dev/provider-vsphere-api/client/clientset/versioned/scheme"
...
func init() {
	_ = vspherescheme.AddToScheme(scheme)
...
func NewCmdRun(version string) *cobra.Command {
	cmd := &cobra.Command{
		Use:               "run",
		Short:             "Launch Kubeform vsphere Provider controller",
		DisableAutoGenTag: true,
		Run: func(cmd *cobra.Command, args []string) {
			klog.Infoln("Starting provider-vsphere-controller...")
			...
			mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
				...
				LeaderElectionID:       "vsphere.kubeform.com",
			})
			if err != nil {
