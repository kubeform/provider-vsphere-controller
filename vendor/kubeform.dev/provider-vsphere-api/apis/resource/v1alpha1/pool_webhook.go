...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-resource-vsphere-kubeform-com-v1alpha1-pool,mutating=false,failurePolicy=fail,groups=resource.vsphere.kubeform.com,resources=pools,versions=v1alpha1,name=pool.resource.vsphere.kubeform.io,sideEffects=None,admissionReviewVersions=v1
...
func (r *Pool) ValidateDelete() error {
	if r.Spec.TerminationPolicy == base.TerminationPolicyDoNotTerminate {
		return fmt.Errorf(`pool "%v/%v" can't be terminated. To delete, change spec.terminationPolicy to Delete`, r.Namespace, r.Name)
	}
	return nil
}
